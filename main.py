...
async def handle_invite_friends(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        invite_text = (
            ...
            f"Добрый день. "
            f"Все мы размещаем свои материалы в разных платформах. И все знаем, как тяжело пробиться в топ. "
            f"Если считаете, что Ваш голос и Ваши мысли должны увидеть больше людей, добро пожаловать в группу единомышленников!\n\n"
